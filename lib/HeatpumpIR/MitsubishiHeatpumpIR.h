...
#define MITSUBISHI_AIRCON2_MODE_AUTO  0x20 // MSZ auto mode - KU
#define MITSUBISHI_AIRCON3_MODE_AUTO  0x60 // FA auto mode
#define MITSUBISHI_AIRCON1_MODE_HEAT  0x08
#define MITSUBISHI_AIRCON2_MODE_HEAT  0x08 // MSZ heat mode - KU
...
#define MITSUBISHI_AIRCON2_MODE_DRY   0x10 // MSY DRY mode - KU updated
